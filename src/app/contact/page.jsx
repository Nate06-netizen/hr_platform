...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-8 sm:py-12 md:py-16 bg-gray-50">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 bg-white p-4 sm:p-6 md:p-8 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg">
        {/* Contact Information */}
